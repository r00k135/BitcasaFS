...
class Bitcasa:
	...
	def __init__ (self, config_path, bcfslog):
		...
		self.httpsPool = urllib3.HTTPSConnectionPool(self.api_host, maxsize=self.NUM_SOCKETS, timeout=urllib3.Timeout(connect=5.0, read=10.0))
